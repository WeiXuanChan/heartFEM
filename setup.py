...
setup(
  ...
  version = '3.4.3',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/WeiXuanChan/heartFEM/archive/v3.4.3.tar.gz',    
