...
setup(
  ...
  version = '3.0.4',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/WeiXuanChan/heartFEM/archive/v3.0.4.tar.gz',    
